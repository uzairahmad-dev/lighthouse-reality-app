  ...
  return (
    <form className="sign-up__form" onSubmit={handleSubmit(formSubmit)}>
        <FormHeader 
            ...
            subHeading='Become a member at Lighthouse Realty by just entering your information and start Selling.' 
        />
        ...
        <div className='sign-up__form--single-line u-margin-top-small'>
            ...
            <input className={`sign-up__form--input sign-up__form--input--small ${errors.sold && 'sign-up__form--input--error'}`} type="number" placeholder="Total Sold Properties" {...register('sold')} />
        </div>
        {
            errors.sold && 
            <div className='sign-up__form--error-div'>
        ...
        <div className='sign-up__form--single-line u-margin-top-small'>
            ...
            <input className={`sign-up__form--input sign-up__form--input--small ${errors.experience && 'sign-up__form--input--error'}`} type="number" placeholder="Total Experience" {...register('experience')} />
        </div>
        {   
            errors.experience && 
            <div className='sign-up__form--error-div'>
